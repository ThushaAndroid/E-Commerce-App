...
import com.thushan.ecommerce.activities.CartActivity;
import com.thushan.ecommerce.activities.PaymentActivity;
...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyCartAdapter.ViewHolder holder, int position) {
        ...
        holder.total.setText("$"+list.get(position).getTotalPrice());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private TextView name,price,time,date,qty,total;
